...
import { CreateGenBetModal } from "./CreateGenBetModal";
import { useBets } from "@/lib/hooks/useGenBets";
import { Logo, LogoMark } from "./Logo";

export function GenBetsNavbar() {
  ...
  const acceptedBets = bets?.filter((bet: { status: string }) => bet.status === "accepted").length || 0;
  const resolvedBets = bets?.filter((bet: { status: string }) => bet.status === "resolved").length || 0;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2">GenBets</span>
              </div>
              ...
              <div className="hidden md:flex items-center gap-6 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-foreground font-bold text-accent">{acceptedBets}</span>
                </div>
                <div className="flex items-center gap-2">
